  ...
  return (
    <div class="px-4 mt-4 text-gray-400">
      ...
      <ul class="list-disc px-6">
        ...
        <li>Linux/DevOps: <Tag tag="Ansible" />, <Tag tag="Docker" />, <Tag tag="git" />, <Tag tag="Grafana" />, <Tag tag="Helm" />, <Tag tag="Kubernetes" />, <Tag tag="LXD/Incus" />, <Tag tag="MySQL" />, <Tag tag="PostgreSQL" />, <Tag tag="Prometheus" />, <Tag tag="Python" /></li>
